...
FW.Scraper({
itemType		: 'bill',
detect			: FW.Xpath('//dl[@class="definitions"]/dd[2]').text().match(/^(Kommittédirektiv|Departementsserien|Statens|Lagrådsremiss|Proposition)/),
language		: 'sv-SE',
url				: FW.Url(),
...
var testCases = [
	...
	{
		"type": "web",
		"url": "http://www.regeringen.se/sb/d/108/a/3738",
		"items": [
			{
				"itemType": "bill",
				"creators": [],
				...
				"attachments": [
					{
						"title": "Del 1 (t.o.m. kap. 3) Perspektiv på Ubåtsfrågan (pdf 2,7 MB)",
						"type": "application/pdf"
					},
					{
						"title": "Del 2 (t.o.m. kap. 5) (pdf 2,0 MB)",
						"type": "application/pdf"
					},
					{
						"title": "Del 3 (t.o.m. kap. 8) (pdf 1,4 MB)",
						"type": "application/pdf"
					},
					{
						"title": "Del 4 (t.o.m. bilagorna) (pdf 380 kB)",
						"type": "application/pdf"
					}
				],
				"url": "http://www.regeringen.se/sb/d/108/a/3738",
				"abstractNote": "Debatten kring främmande undervattensverksamhet på svenskt territorium har varit intensiv under de senaste två decennierna. Konstaterade kränkningar och indikationer om kränkningar har undersökts av två kommissioner.",
				"billNumber": "SOU 2001:85",
				"date": "15 november 2001",
				"language": "sv-SE",
				"legislativeBody": "Regeringen",
				"libraryCatalog": "Regeringen",
				"shortTitle": "SOU 2001:85",
				"title": "Perspektiv på Ubåtsfrågan",
				"accessDate": "CURRENT_TIMESTAMP"
			}
		]
	}
